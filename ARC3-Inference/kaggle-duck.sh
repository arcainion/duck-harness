...
#   KAGGLE_DUCK_SMOKE_TEST_ONLY=false
#   KAGGLE_DUCK_DIAGNOSTIC_GAMES=["ar25-0c556536"]
#   KAGGLE_DUCK_OBJECTIVE_REDUCTION=false
...
KAGGLE_DUCK_SMOKE_TEST_ONLY="${KAGGLE_DUCK_SMOKE_TEST_ONLY:-false}"
KAGGLE_DUCK_OBJECTIVE_REDUCTION="${KAGGLE_DUCK_OBJECTIVE_REDUCTION:-false}"
KAGGLE_DUCK_DIAGNOSTIC_GAMES="${KAGGLE_DUCK_DIAGNOSTIC_GAMES:-[\"ar25-0c556536\"]}"
LOCAL_ANALYZER_ORCHESTRATION_REQUEST_TIMEOUT_SECONDS="${LOCAL_ANALYZER_ORCHESTRATION_REQUEST_TIMEOUT_SECONDS:-300}"
LOCAL_ANALYZER_ORCHESTRATION_REDUCER_MAX_OUTPUT="${LOCAL_ANALYZER_ORCHESTRATION_REDUCER_MAX_OUTPUT:-4096}"
LOCAL_ANALYZER_ORCHESTRATION_CODER_MAX_OUTPUT="${LOCAL_ANALYZER_ORCHESTRATION_CODER_MAX_OUTPUT:-8192}"
LOCAL_ANALYZER_ORCHESTRATION_REDUCER_THINKING_BUDGET="${LOCAL_ANALYZER_ORCHESTRATION_REDUCER_THINKING_BUDGET:-2048}"
LOCAL_ANALYZER_ORCHESTRATION_CODER_THINKING_BUDGET="${LOCAL_ANALYZER_ORCHESTRATION_CODER_THINKING_BUDGET:-1024}"
LOCAL_GAMEPLAY_POLICY_BACKEND="${LOCAL_GAMEPLAY_POLICY_BACKEND:-cpu}"
LOCAL_GAMEPLAY_POLICY_CUDA_MIN_FREE_MB="${LOCAL_GAMEPLAY_POLICY_CUDA_MIN_FREE_MB:-4096}"
LOCAL_GAMEPLAY_POLICY_DECISION_TIMEOUT_SECONDS="${LOCAL_GAMEPLAY_POLICY_DECISION_TIMEOUT_SECONDS:-2}"
...
make_args+=(
    ...
    KAGGLE_DUCK_SMOKE_TEST_ONLY="${KAGGLE_DUCK_SMOKE_TEST_ONLY}"
    DEPLOYMENT_WAIT="${DEPLOYMENT_WAIT}"
    LOCAL_ANALYZER_OBJECTIVE_REDUCTION="${KAGGLE_DUCK_OBJECTIVE_REDUCTION}"
    LOCAL_ANALYZER_ORCHESTRATION_REQUEST_TIMEOUT_SECONDS="${LOCAL_ANALYZER_ORCHESTRATION_REQUEST_TIMEOUT_SECONDS}"
    LOCAL_ANALYZER_ORCHESTRATION_REDUCER_MAX_OUTPUT="${LOCAL_ANALYZER_ORCHESTRATION_REDUCER_MAX_OUTPUT}"
    LOCAL_ANALYZER_ORCHESTRATION_CODER_MAX_OUTPUT="${LOCAL_ANALYZER_ORCHESTRATION_CODER_MAX_OUTPUT}"
    LOCAL_ANALYZER_ORCHESTRATION_REDUCER_THINKING_BUDGET="${LOCAL_ANALYZER_ORCHESTRATION_REDUCER_THINKING_BUDGET}"
    LOCAL_ANALYZER_ORCHESTRATION_CODER_THINKING_BUDGET="${LOCAL_ANALYZER_ORCHESTRATION_CODER_THINKING_BUDGET}"
    LOCAL_GAMEPLAY_POLICY_BACKEND="${LOCAL_GAMEPLAY_POLICY_BACKEND}"
    LOCAL_GAMEPLAY_POLICY_CUDA_MIN_FREE_MB="${LOCAL_GAMEPLAY_POLICY_CUDA_MIN_FREE_MB}"
    LOCAL_GAMEPLAY_POLICY_DECISION_TIMEOUT_SECONDS="${LOCAL_GAMEPLAY_POLICY_DECISION_TIMEOUT_SECONDS}"
)
